...
@section('content')
    ...
    <div class="container">
        <img class="" src="assets/img/course/education_banner.jpg" style="height:300px; width:100%; border-style: inset;">
    </div>
    ...
    <section class="clean-block clean-blog-list dark" style="background-image: linear-gradient(to left, green,#fde8ec);">
            <div class="container">
                ...
                //    if(!isset($_POST['search'])){  
                //     $sql = $conn->query("SELECT * FROM tnr_dataset WHERE College = 'Education' LIMIT $start_from, $per_page_record"); 
                //    }      
                ...
                ?>
                    ...
                    <?php //}
                     ...
                     <div class="d-flex justify-content-center">  
                        <?php  
                            // $sql = "SELECT COUNT(*) FROM tnr_dataset WHERE College='Education'";     
                            ...
                            // if($page>=2){   
                            //     echo "<button class='btn btn-dark' style='border: 2px solid #4CAF50;'><a href='guesteducation.php?page=".($page-1)."'>  Prev </a></button>";   
                            // }       
                                    
                            // for ($i=1; $i<=$total_pages; $i++) {   
                            // if ($i == $page) {   
                            //     $pagLink .= "<button class='btn btn-dark' style='border: 2px solid #4CAF50;'><a style='' class='active' href='guesteducation.php?page="  
                            //                                         .$i."'><b>".$i." </b></a></button>";   
                            // }               
                            // else  {   
                            //     $pagLink .= "<button class='btn btn-dark' style='border: 2px solid #4CAF50;'><a href='guesteducation.php?page=".$i."'>   
                            //                                         ".$i." </a></button>";     
                            // }   
                            // };     
                            // echo $pagLink;   
                            ...
                            // if($page<$total_pages){   
                            //     echo "<button class='btn btn-dark' style='border: 2px solid #4CAF50;'><a href='guesteducation.php?page=".($page+1)."'>  Next </a></button>";   
                            // }   
                        ?>    
                    </div>  
